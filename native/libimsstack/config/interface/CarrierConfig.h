...
public:
    ...
    public:
        ...
        static const IMS_CHAR KEY_DISABLE_T3482_FOR_EMC_BOOL[];
        ...
        static const IMS_CHAR KEY_REQUIRED_EMC_REG_IN_ROAMING_BOOL[];
        ...
        static const IMS_CHAR KEY_UPDATE_REG_WITH_COUNTRY_CHANGE_BOOL[];

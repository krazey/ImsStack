...
public:
    ...
    public:
        ...
        static const IMS_CHAR KEY_EMC_REG_ON_RANDOM_PCSCF_BOOL[];
        ...
        static const IMS_CHAR KEY_EMC_REG_RETRY_MAX_CNT_INT[];
        static const IMS_CHAR KEY_EMC_REG_RETRY_TIMER_MILLIS_INT[];

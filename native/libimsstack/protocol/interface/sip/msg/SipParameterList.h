...
public:
    ...
    SIP_BOOL DecUriSipParameterList(SIP_CHAR* pStartPt, SIP_CHAR* pEndPt, SIP_CHAR cDelimiter,
            IParameterComponent* pParameterComponent = SIP_NULL);

    SIP_BOOL DecUriHdrSipParameterList(SIP_CHAR* pStartPt, SIP_CHAR* pEndPt, SIP_CHAR cDelimiter,
            IParameterComponent* pParameterComponent = SIP_NULL);

    SIP_BOOL Remove(const SIP_CHAR* pszName);

    SIP_BOOL DecHdrSipParameterList(SIP_CHAR* pStartPt, SIP_CHAR* pEndPt, SIP_CHAR cDelimiter);

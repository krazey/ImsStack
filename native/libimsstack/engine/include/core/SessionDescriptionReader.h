 ...
 */
#ifndef SESSION_DESCRIPTION_READER_H_
#define SESSION_DESCRIPTION_READER_H_

#include "SdpSessionDescription.h"

#include "ISessionDescriptor.h"

class SessionDescriptionReader : public ISessionDescriptor
{
public:
    explicit SessionDescriptionReader(IN const SdpSessionDescription& objSsd) :
            m_objSsd(objSsd)
    {
    }
...
private:
    SdpSessionDescription m_objSsd;
};

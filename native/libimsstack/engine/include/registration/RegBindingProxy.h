...
public:
    ...
    static void DestroyBinding(IN IMS_SINT32 nSlotId, IN const IRegistrationEx* piRegEx);
    ...
    static void UnbindContact(
            IN IMS_SINT32 nSlotId, IN const AString& strAppId, IN const AString& strServiceId);
    static void UnbindContact(IN IMS_SINT32 nSlotId, IN const IRegContact* piContact);

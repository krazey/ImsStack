...
#define IMS_LTE_CSFB_PREF_SUB_STATE (34) // update current ims reg state for hVoLTE (state 0(CSFB))
#define IMS_LTE_UPDATE_CURRENT_REG_STATE (35) // update current ims reg state for hVoLTE

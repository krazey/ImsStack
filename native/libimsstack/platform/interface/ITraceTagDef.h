...
// COMMON -- starts
__IMS_TRACE_TAG_DEF__(IPL, "IPL", BASE)
__IMS_TRACE_TAG_DEF__(BASE, "BASE", BASE)
__IMS_TRACE_TAG_DEF__(CONF, "CONF", BASE)
__IMS_TRACE_TAG_DEF__(REG, "REG", REG)
__IMS_TRACE_TAG_DEF__(IMS_CORE, "IMS.CORE", IMS_CORE)
__IMS_TRACE_TAG_DEF__(SIP_CORE, "SIP.CORE", SIP_CORE)
...
// ENABLER -- starts
__IMS_TRACE_TAG_DEF__(AOS, "AOS", ENABLER_AOS)

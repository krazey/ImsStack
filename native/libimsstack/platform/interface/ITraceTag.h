...
typedef enum _IMS_TRACE_MODULE_ENTYPE_
{
    ...
    IMS_TRACE_MODULE_REG = 0x00000001,       // REG
    IMS_TRACE_MODULE_IMS_CORE = 0x00000002,  // IMS_CORE
    IMS_TRACE_MODULE_BASE = 0x00000004,      // BASE, CONF, IPL
    IMS_TRACE_MODULE_SIP = 0x00000008,       // SIP
    IMS_TRACE_MODULE_XML = 0x00000010,       // XML
    IMS_TRACE_MODULE_SDP = 0x00000020,       // SDP
    IMS_TRACE_MODULE_AOS = 0x00000100,       // AOS

...
// DEFAULT TRACE TAG
#define __IMS_TRACE_DEFAULT_NAME__ "MISC"
...
////
// TRACE TAG ENUMERATION DEFINITION
////
...
////
// TRACE MODULE ENUMERATION DEFINITION
////
typedef enum _IMS_TRACE_MODULE_ENTYPE_
{
    IMS_TRACE_MODULE_NONE = 0,  // no modules : no trace enabled

    IMS_TRACE_MODULE_BASE = 0x00000001,      // BASE, CONF, IPL
    IMS_TRACE_MODULE_REG = 0x00000002,       // REG
    IMS_TRACE_MODULE_IMS_CORE = 0x00000004,  // IMS.CORE
    IMS_TRACE_MODULE_SIP_CORE = 0x00000008,  // SIP.CORE
    IMS_TRACE_MODULE_SIP = 0x00000010,       // SIP
    IMS_TRACE_MODULE_XML = 0x00000020,       // XML
    IMS_TRACE_MODULE_SDP = 0x00000040,       // SDP

    IMS_TRACE_MODULE_ENABLER_AOS = 0x00010000,           // ENABLER: AOS
    IMS_TRACE_MODULE_ENABLER_MTC = 0x00020000,           // ENABLER: MTC
    IMS_TRACE_MODULE_ENABLER_MTS = 0x00040000,           // ENABLER: MTS
    IMS_TRACE_MODULE_ENABLER_UCE = 0x00080000,           // ENABLER: UCE
    IMS_TRACE_MODULE_ENABLER_MEDIA = 0x00100000,         // ENABLER: MEDIA
    IMS_TRACE_MODULE_ENABLER_SIP_DELEGATE = 0x00200000,  // ENABLER: SIP_DELEGATE

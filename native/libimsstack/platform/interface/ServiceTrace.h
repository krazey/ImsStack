...
{\
    ...
    {\
        char acFileNameForTrace__[128] = {0,};\
...
{\
    ...
    {\
        char acFileNameForTrace__[128] = {0,};\
        pTs->GetTrace()->OutE(ECODE,__IMS_FUNC__,__IMS_LINE__,\
                __IMS_TRACE_NAME__,__IMS_TRACE_MODULE__,\
                "[%s:%d] " FORMAT,pTs->GetFileName(acFileNameForTrace__,__IMS_FILE__),\
                __IMS_LINE__,A1,A2,A3);\
    }\
} while(0)
...
{\
    ...
    {\
        ...
        pTs->GetTrace()->OutE(ECODE,__IMS_FUNC__,__IMS_LINE__,\
                __IMS_TRACE_NAME__,__IMS_TRACE_MODULE__,\
                "[%s:%4d] [%s] " FORMAT,pTs->GetFileName(acFileNameForTrace__,__IMS_FILE__),\
                __IMS_LINE__,ID,A1,A2,A3);\
    }\
} while(0)
...
{\
    ...
    {\
        ...
        {\
            char acFileNameForTrace__[128] = {0,};\
            pTs->GetTrace()->Out(ITrace::CAT_D,TAG,IMS_TRACE_MODULE_IMS,\
                    "[%s:%d] " FORMAT,pTs->GetFileName(acFileNameForTrace__,__IMS_FILE__),\
                    __IMS_LINE__,A1,A2,A3);\
        }\
    } while(0)

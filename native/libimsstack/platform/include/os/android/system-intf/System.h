...
public:
    ...
    ////
    IMS_SINT32 GetDeviceId(OUT AString& strDeviceId, IN IMS_SINT32 nSlotId) override;
    IMS_SINT32 GetDeviceSoftwareVersion(OUT AString& strSv, IN IMS_SINT32 nSlotId) override;
    ...
    IMS_SINT32 GetVoiceNetworkType(IN IMS_SINT32 nSlotId) override;
    IMS_SINT32 GetRoamingState(IN IMS_SINT32 nSlotId) override;
    ...
    AString GetIfaceName(IN IMS_SINT32 nApnType, IN IMS_SINT32 nSlotId) override;
    IMS_SINT32 GetIpcanCategory(IN IMS_SINT32 nApnType, IN IMS_SINT32 nSlotId) override;
    ...
    IMS_SINT32 GetLteRsrpStrength(IN IMS_SINT32 nSlotId) override;
    ...
    IMS_SINT32 GetPreference(IN const AString& strFileName, IN const AString& strKey,
            IN IMS_UINT32 nValueType, IN IMS_SINT32 nSlotId, OUT AString& strValue) override;
    IMS_SINT32 SetPreference(IN const AString& strFileName, IN const AString& strKey,
            IN IMS_UINT32 nValueType, IN const AString& strValue, IN IMS_SINT32 nSlotId) override;
    ...
    IMS_SINT32 SetPrivateProperty(IN IMS_BOOL bPersistent, IN const AString& strKey,
            IN const AString& strValue, IN IMS_SINT32 nSlotId) override;
    IMS_BOOL GetCarrierConfig(IN IMS_SINT32 nSlotId, OUT ImsParcel& objConfig) override;
    ...
    IMS_SINT32 SendEvent(IN IMS_SINT32 nEvent, IN IMS_UINT32 nWParam, IN IMS_UINT32 nLParam,
            IN IMS_SINT32 nSlotId) override;
    IMS_SINT32 SetEvent(IN IMS_SINT32 nEvent, IN IMS_SINT32 nSlotId) override;
    IMS_SINT32 ResetEvent(IN IMS_SINT32 nEvent, IN IMS_SINT32 nSlotId) override;

    ////
    // WFC information
    ////
    IMS_BOOL IsWifiCallingEnabled(IN IMS_SINT32 nSlotId) override;
    IMS_SINT32 GetWifiCallingPreferences(IN IMS_SINT32 nSlotId) override;
    IMS_BOOL IsWifiCallingProvisioned(IN IMS_SINT32 nSlotId) override;
    AString GetWifiCallingAddressId(IN IMS_SINT32 nSlotId) override;
    ...
    void RemoveIpSecSaParameter(IN IMS_SINT32 nIpSecId, IN IMS_SINT32 nSlotId) override;

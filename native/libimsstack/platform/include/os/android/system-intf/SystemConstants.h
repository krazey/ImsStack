...
public:
    ...
    static const IMS_UINT32 GET_VOICE_SERVICE_STATE = CATEGORY_BASE + 421;
    static const IMS_UINT32 GET_VOICE_ROAMING_TYPE = CATEGORY_BASE + 422;
    static const IMS_UINT32 GET_DATA_ROAMING_TYPE = CATEGORY_BASE + 423;
    static const IMS_UINT32 GET_MTU = CATEGORY_BASE + 424;
    static const IMS_UINT32 IS_EMERGENCY_ATTACH_SUPPORTED = CATEGORY_BASE + 425;
    static const IMS_UINT32 BIND_SOCKET = CATEGORY_BASE + 426;
    static const IMS_UINT32 IS_IPV6_PREFERRED = CATEGORY_BASE + 427;
    static const IMS_UINT32 GET_NETWORK_REGISTRATION_REJECT_CAUSE = CATEGORY_BASE + 428;
    static const IMS_UINT32 GET_CELLULAR_SERVICE_STATE = CATEGORY_BASE + 429;
    static const IMS_UINT32 GET_ACCESS_NETWORK_PLMN = CATEGORY_BASE + 430;
    static const IMS_UINT32 IS_DATA_NETWORK_ROAMING = CATEGORY_BASE + 431;

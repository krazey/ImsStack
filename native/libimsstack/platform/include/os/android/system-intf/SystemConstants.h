...
public:
    ...
    static const IMS_UINT32 IS_IMS_EMERGENCY_CALL_SUPPORTED = CATEGORY_BASE + 418;
    static const IMS_UINT32 GET_VOICE_NETWORK_TYPE = CATEGORY_BASE + 419;
    static const IMS_UINT32 IS_LTE_EMERGENCY_ONLY = CATEGORY_BASE + 420;
    static const IMS_UINT32 IS_MOBILE_DATA_ENABLED = CATEGORY_BASE + 421;
    static const IMS_UINT32 GET_MOCN_PLMN_INFO = CATEGORY_BASE + 422;
    static const IMS_UINT32 GET_VOICE_SERVICE_STATE = CATEGORY_BASE + 423;
    static const IMS_UINT32 GET_VOICE_ROAMING_TYPE = CATEGORY_BASE + 424;
    static const IMS_UINT32 GET_DATA_ROAMING_TYPE = CATEGORY_BASE + 425;
    static const IMS_UINT32 GET_MTU = CATEGORY_BASE + 426;
    static const IMS_UINT32 IS_EMERGENCY_ATTACH_SUPPORTED = CATEGORY_BASE + 427;
    static const IMS_UINT32 BIND_SOCKET = CATEGORY_BASE + 428;

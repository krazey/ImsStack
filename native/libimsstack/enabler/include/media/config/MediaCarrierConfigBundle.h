...
{
public:
    MediaAmrnbPayloadDescriptionBundle() : //KEY_AMRNB_PAYLOAD_DESCRIPTION_BUNDLE
...
{
public:
    MediaAmrwbPayloadDescriptionBundle() : //KEY_AMRWB_PAYLOAD_DESCRIPTION_BUNDLE
...
public:
    ...
    MediaEvsPayloadDescriptionBundle() : //KEY_EVS_PAYLOAD_DESCRIPTION_BUNDLE
            ...
            nCodecAttributeModeChangeCapability(1),//KEY_CODEC_ATTRIBUTE_MODE_CHANGE_CAPABILITY_INT
...
public:
    ...
    IMS_SINT32 nCodecAttributeModeChangeCapability; //KEY_CODEC_ATTRIBUTE_MODE_CHANGE_CAPABILITY_INT
...
{
public:
    MediaTextCodecCapabilityPayloadTypesBundle() : //KEY_TEXT_CODEC_CAPABILITY_PAYLOAD_TYPES_BUNDLE
...
{
public:
    MediaH264PayloadDescriptionBundle() : //KEY_H264_PAYLOAD_DESCRIPTION_BUNDLE

...
*/
 ...
 protected:
  ...
  virtual void ImsAos_Connected(IN IMS_UINT32 nFeatures,
                                IN IMS_UINT32 nIpcan) override;
  ...
  virtual void ImsAosMonitor_Connected(IN IMS_UINT32 nServices,
                                       IN IMS_UINT32 nIpcan) override;
  virtual void ImsAosMonitor_Notify(IN IMS_UINT32 nType,
                                    IN IMS_UINT32 nState) override;
...
*/
 protected:
  enum { AMSG_BASE = IMS_MSG_USER + 1, AMSG_CREATE_SERVICE, AMSG_MAX };
  enum {

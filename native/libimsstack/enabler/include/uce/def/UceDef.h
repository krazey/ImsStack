...
#define MSG_THREAD_RECEIVED_NOTIFY_RLMI \
  50  // received notify msg include rlmi xml body.
#define MSG_THREAD_RECEIVED_NOTIFY_PIDF \
  51  // received notify msg include pidf xml body.

...
public:
    ...
    {
        IMS_TRACE_MEM("mtc",
                "mtc_M : UCInterMsgTerminateSessionCmdParam[%" PFLS_u "]"
                "[%" PFLS_x "]",
                sizeof(UCInterMsgTerminateSessionCmdParam), this, 0);
    }
    inline virtual ~UCInterMsgTerminateSessionCmdParam()
    {
        IMS_TRACE_MEM("mtc",
                "mtc_F : UCInterMsgTerminateSessionCmdParam[%" PFLS_u "]"
                "[%" PFLS_x "]",
                sizeof(UCInterMsgTerminateSessionCmdParam), this, 0);
    }
...
public:
    ...
    {
        IMS_TRACE_MEM("mtc",
                "mtc_M : UCInterMsgUpdateSessionServiceCmdParam[%" PFLS_u "]"
                "[%" PFLS_x "]",
                sizeof(UCInterMsgUpdateSessionServiceCmdParam), this, 0);
    }
    inline virtual ~UCInterMsgUpdateSessionServiceCmdParam()
    {
        IMS_TRACE_MEM("mtc",
                "mtc_F : UCInterMsgUpdateSessionServiceCmdParam[%" PFLS_u "]"
                "[%" PFLS_x "]",
                sizeof(UCInterMsgUpdateSessionServiceCmdParam), this, 0);
    }

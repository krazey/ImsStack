...
public:
    ...
    virtual void NotificationDeliveryFailed(IN IServiceMethod* piMethod, IN IMS_SINT32 nStatusCode);
...
protected:
    ...
    virtual void SendNotifyDeliveryFailedToListn(

...
enum class PermanentSuppType
{
    ...
    TB_CB_INCOMING_ALL_VOICE = 6,
    TB_CB_INCOMING_ALL_VIDEO = 7,
    TB_CB_INCOMING_ROAMING_VOICE = 8,
    TB_CB_INCOMING_ROAMING_VIDEO = 9,
    TB_CB_INCOMING_ANONYMOUS_VOICE = 10,
    TB_CB_INCOMING_ANONYMOUS_VIDEO = 11,
};

...
enum
{
    ...
    CODE_INTERNAL_USSI_COMPLETED = 10006,
};
...
enum
{
    ...
    EXTRA_CODE_CALL_RETRY_EMERGENCY = 4,
};
...
enum
{
    ...
    EXTRA_CODE_REDIAL_FOR_SDP_CHANGE = 4,
    EXTRA_CODE_REDIAL_BY_EPS_FALLBACK = 5,
    EXTRA_CODE_REDIAL_BY_EPS_FALLBACK_WITH_REG = 6,
    ...
    EXTRA_CODE_REDIAL_EMERGENCY_WITH_ANONYMOUS = 10,
    EXTRA_CODE_REDIAL_WITH_NEXT_PCSCF_ONCE = 11,
};
...
enum
{
    ...
    EXTRA_CODE_EMERGENCYSERVICE_POLICE = 1,
    EXTRA_CODE_EMERGENCYSERVICE_AMBULANCE = 2,
    EXTRA_CODE_EMERGENCYSERVICE_FIRE = 3,
    EXTRA_CODE_EMERGENCYSERVICE_MARINE = 4,
    EXTRA_CODE_EMERGENCYSERVICE_MOUNTAIN = 5,
    EXTRA_CODE_EMERGENCYSERVICE_MIEC = 6,
    EXTRA_CODE_EMERGENCYSERVICE_AIEC = 7,
    EXTRA_CODE_EMERGENCYSERVICE_COUNTRY_SPECIFIC = 8,

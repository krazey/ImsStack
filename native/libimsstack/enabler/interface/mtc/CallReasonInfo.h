...
enum
{
    ...
    CODE_SIP_REDIRECTED = 801,
    CODE_SIP_BAD_REQUEST = 802,
    CODE_SIP_FORBIDDEN = 803,
    CODE_SIP_NOT_FOUND = 804,
    CODE_SIP_NOT_SUPPORTED = 805,
    CODE_SIP_REQUEST_TIMEOUT = 806,
    CODE_SIP_TEMPORARILY_UNAVAILABLE = 807,
    CODE_SIP_BAD_ADDRESS = 808,
    CODE_SIP_BUSY = 809,
    CODE_SIP_REQUEST_CANCELLED = 810,
    CODE_SIP_NOT_ACCEPTABLE = 811,
    CODE_SIP_NOT_REACHABLE = 812,
    CODE_SIP_CLIENT_ERROR = 813,
    CODE_SIP_TRANSACTION_DOES_NOT_EXIST = 814,
    CODE_SIP_SERVER_INTERNAL_ERROR = 815,
    CODE_SIP_SERVICE_UNAVAILABLE = 816,
    CODE_SIP_SERVER_TIMEOUT = 817,
    CODE_SIP_SERVER_ERROR = 818,
    CODE_SIP_USER_REJECTED = 819,
    CODE_SIP_GLOBAL_ERROR = 820,
    CODE_SIP_METHOD_NOT_ALLOWED = 821,
    CODE_SIP_PROXY_AUTHENTICATION_REQUIRED = 822,
    CODE_SIP_REQUEST_ENTITY_TOO_LARGE = 823,
    CODE_SIP_REQUEST_URI_TOO_LARGE = 824,
    CODE_SIP_EXTENSION_REQUIRED = 825,
    CODE_SIP_INTERVAL_TOO_BRIEF = 826,
    CODE_SIP_CALL_OR_TRANS_DOES_NOT_EXIST = 827,
    CODE_SIP_LOOP_DETECTED = 828,
    CODE_SIP_TOO_MANY_HOPS = 829,
    CODE_SIP_AMBIGUOUS = 830,
    CODE_SIP_REQUEST_PENDING = 831,
    CODE_SIP_UNDECIPHERABLE = 832,

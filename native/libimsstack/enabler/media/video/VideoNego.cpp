...
VIRTUAL IMS_BOOL VideoNego::MakeNegotiatedProfile(IN VideoProfile* pLocalProfile,
        ...
        OUT VideoProfile* pNegotiatedProfile)
{
    ...
    IMS_TRACE_I(
            "MakeNegotiatedProfile() - PeerProfile: SupportCapaNegoForAVPF[%d], bSupportAvpf[%d]",

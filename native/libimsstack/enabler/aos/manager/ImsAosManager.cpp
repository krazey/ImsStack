...
PUBLIC VIRTUAL ImsAosManager::~ImsAosManager()
{
...
PUBLIC
IImsAos* ImsAosManager::GetImsAos(
...
PUBLIC VIRTUAL IMS_BOOL ImsAosManager::OnMessage(IN IMSMSG& /*objMSG*/)
{
    return IMS_TRUE;
}

PUBLIC VIRTUAL IMS_BOOL ImsAosManager::OnPostprocess(IN IMSMSG& /*objMSG*/)
{
    return IMS_TRUE;
}

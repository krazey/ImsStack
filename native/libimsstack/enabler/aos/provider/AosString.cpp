...
const IMS_CHAR AosString::STR_REG_RETRY_TIME0[] = "ims.reg_retry_time0";
const IMS_CHAR AosString::STR_REG_RETRY_TIME1[] = "ims.reg_retry_time1";
const IMS_CHAR AosString::STR_EMERGENCY_CALL_FAIL_CAUSE[] = "ims.emergency_call_fail_cause";

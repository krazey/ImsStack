...
public:
    ...
    inline ImsMap<IMS_UINT32, IMS_UINT32> GetCapabilities() const { return m_objCapabilities; }
    ...
    inline IMS_UINT32 GetHoldingVopsState() const { return m_nHoldingVopsState; }
};

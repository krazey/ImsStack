...
{
    const ReferenceInterfaceHolder* pHolder1 = pFactory->GetIReferenceHolder();
    ASSERT_NE(pHolder1, nullptr);
    const ReferenceInterfaceHolder* pHolder2 = pFactory->GetIReferenceHolder();
...
{
    const SubscriptionInterfaceHolder* pHolder1 = pFactory->GetISubscriptionHolder();
    ASSERT_NE(pHolder1, nullptr);
    const SubscriptionInterfaceHolder* pHolder2 = pFactory->GetISubscriptionHolder();
    EXPECT_EQ(pHolder1, pHolder2);
}

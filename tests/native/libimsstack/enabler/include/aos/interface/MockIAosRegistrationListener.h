 ...
 */
#ifndef MOCK_I_AOS_REGISTRATION_LISTENER_H_
#define MOCK_I_AOS_REGISTRATION_LISTENER_H_

#include <gmock/gmock.h>

#include "interface/IAosRegistrationListener.h"

class MockIAosRegistrationListener : public IAosRegistrationListener
{
public:

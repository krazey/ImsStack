...
class MockEpsFallbackTrigger : public EpsFallbackTrigger
{
public:
    explicit MockEpsFallbackTrigger(IN IMtcCallContext& objContext) :
            EpsFallbackTrigger(objContext)
    {
    }
    ~MockEpsFallbackTrigger() {}

    MOCK_METHOD(IMS_BOOL, IsVoNr, (), (const, override));

...
#ifndef MOCK_I_EMERGENCY_NORMAL_ROUTING_HELPER_LISTENER_H_
...
{
public:
    virtual ~MockIEmergencyNormalRoutingHelperListener() {}
    MOCK_METHOD(void, OnNormalRoutingClosed, (), (override));
};

...
#ifndef MOCK_I_DIALOG_SUBSCRIPTION_H_
#define MOCK_I_DIALOG_SUBSCRIPTION_H_
...
public:
    ...
    MOCK_METHOD(void, OnSubscriptionTerminated, (), (override));
    MOCK_METHOD(void, OnSubscriptionNotified, (IN const AString&), (override));
};

...
public:
    ...
    MOCK_METHOD(void, OnStarted, (IN const JniCallInfo&, IN MediaInfo*,
            (IN const ImsMap<SuppType, SuppService*>&)), (override));
    MOCK_METHOD(void, OnStartFailed, (IN const CallReasonInfo&), (override));
    MOCK_METHOD(void, OnProgressing, (IN const JniCallInfo&, IN MediaInfo*,
            (IN const ImsMap<SuppType, SuppService*>&), IN IMS_BOOL), (override));
    MOCK_METHOD(void, OnHeld, (IN const JniCallInfo&, IN MediaInfo*,
            (IN const ImsMap<SuppType, SuppService*>&)), (override));
    MOCK_METHOD(void, OnHoldFailed, (IN const CallReasonInfo&), (override));
    MOCK_METHOD(void, OnResumed, (IN const JniCallInfo&, IN MediaInfo*,
            (IN const ImsMap<SuppType, SuppService*>&)), (override));
    MOCK_METHOD(void, OnResumeFailed, (IN const CallReasonInfo&), (override));
    MOCK_METHOD(void, OnHeldBy, (IN const JniCallInfo&, IN MediaInfo*,
            (IN const ImsMap<SuppType, SuppService*>&)), (override));
    MOCK_METHOD(void, OnResumedBy, (IN const JniCallInfo&, IN MediaInfo*,
            (IN const ImsMap<SuppType, SuppService*>&)), (override));
    MOCK_METHOD(void, OnTerminated, (IN const CallReasonInfo&), (override));
    MOCK_METHOD(void, OnIncomingResume, (IN const JniCallInfo&,
            IN MediaInfo*, (IN const ImsMap<SuppType, SuppService*>&)), (override));
    MOCK_METHOD(void, OnIncomingUpdate, (IN const JniCallInfo&,
            IN MediaInfo*, (IN const ImsMap<SuppType, SuppService*>&)), (override));
    MOCK_METHOD(void, OnUpdated, (IN const JniCallInfo&, IN MediaInfo*,
            (IN const ImsMap<SuppType, SuppService*>&)), (override));
    MOCK_METHOD(void, OnUpdateFailed, (IN const CallReasonInfo&), (override));
    MOCK_METHOD(void, OnUpdatedBy, (IN const JniCallInfo&, IN MediaInfo*,
            (IN const ImsMap<SuppType, SuppService*>&)), (override));

    MOCK_METHOD(void, OnMerged, (IN const JniCallInfo&, IN MediaInfo*,
            (IN const ImsMap<SuppType, SuppService*>&),
            IN const ImsList<ConfUser*>&), (override));

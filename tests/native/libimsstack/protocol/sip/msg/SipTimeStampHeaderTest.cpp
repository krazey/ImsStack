...
TEST_F(SipTimeStampHeaderTest, EncodeAndEncodeHdr)
{
    ...
    EXPECT_EQ(SIP_TRUE, pHeader->SetTimeVal((char*)"12.56"));
    ...
    EXPECT_EQ(SIP_TRUE, pHeader->SetDelay((char*)"1.30"));
...
TEST_F(SipTimeStampHeaderTest, DecodeHdr)
{
    ...
    EXPECT_EQ(SIP_TRUE, pHeader->DecodeHdr((char*)"12.56", 5));
    ...
    EXPECT_EQ(SIP_TRUE, pHeader->DecodeHdr((char*)"12.56 1.30", 10));

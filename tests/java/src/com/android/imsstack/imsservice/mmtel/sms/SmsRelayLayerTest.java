...
public class SmsRelayLayerTest {
    ...
    @Mock SmsRelayLayer.Listener mListener;
    ...
    private byte[] mMtRpData = {01, 01, 07, (byte) 0x91, 91, 30, 07, 92, 29, (byte) 0xF0, 00, 12,
        21, 11, (byte) 0x0A, 81, 78, 56, 34, 12, 10, 00, 00, 06, 66, (byte) 0xB2, 99, (byte) 0x6C,
        26, 03};
    ...
    private byte[] mFrameworkPdu = {07, (byte) 0x91, 91, 30, 07, 92, 29, (byte) 0xF0, 21, 11,
        (byte) 0x0A, 81, 78, 56, 34, 12, 10, 00, 00, 06, 66, (byte) 0xB2, 99, (byte) 0x6C, 26, 03};
    private byte[] mMoRpData = {00, 01, 00, 07, (byte) 0x91, (byte) 0x91, 0x30, 07,
        (byte) 0x92, 0x29, (byte) 0xF0, 0x12, 21, 11, (byte) 0x0A, 81, 78, 56, 34, 12, 10, 00, 00,
    ...
    @Test
    public void test_VerifyMultipleMoSuccess() {
        try {

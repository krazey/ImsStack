...
public class ImsMmTelServiceTest extends ImsStackTest {
    ...
    private IImsMmTelListener mMockMtelListener;
    ...
    public void setUp() throws Exception {
        ...
        mMockMtelListener = Mockito.mock(IImsMmTelListener.class);
        ...
        mMmTelFeatrure.getBinder().setListener(mMockMtelListener);
    }
    ...
    public void testOnFeatureRemoved() {
        ...
        callApps = serviceManager.getCallAppMap();
    ...
    private TestImsMmTelService createMmTelService(ImsServiceRecord sr) {
        return new TestImsMmTelService(mMockImsContext, sr, mMockServiceRegistry);
    }

    private class TestImsMmTelService extends ImsMmTelService {
        TestImsMmTelService(IContext context, ImsServiceRecord sr, ImsServiceRegistry sreg) {
            super(context, sr, sreg);
        }

...
public interface SubscribeResponse {
   ...
   * for.
   */
    void onNotifyCapabilitiesUpdate(List<String> pidfXmls);
   ...
   */
  void onTerminated(String reason, long retryAfterMilliseconds);
   ...
   */
  void onResourceTerminated(List<Pair<Uri, String>> uriTerminatedReason);
}

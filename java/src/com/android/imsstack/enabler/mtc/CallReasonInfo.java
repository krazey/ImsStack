...
public class CallReasonInfo implements Parcelable {
    ...
    public static final int CODE_SIP_REDIRECTED = 801;
    public static final int CODE_SIP_BAD_REQUEST = 802;
    public static final int CODE_SIP_FORBIDDEN = 803;
    public static final int CODE_SIP_NOT_FOUND = 804;
    public static final int CODE_SIP_NOT_SUPPORTED = 805;
    public static final int CODE_SIP_REQUEST_TIMEOUT = 806;
    public static final int CODE_SIP_TEMPORARILY_UNAVAILABLE = 807;
    public static final int CODE_SIP_BAD_ADDRESS = 808;
    public static final int CODE_SIP_BUSY = 809;
    public static final int CODE_SIP_REQUEST_CANCELLED = 810;
    public static final int CODE_SIP_NOT_ACCEPTABLE = 811;
    public static final int CODE_SIP_NOT_REACHABLE = 812;
    public static final int CODE_SIP_CLIENT_ERROR = 813;
    public static final int CODE_SIP_TRANSACTION_DOES_NOT_EXIST = 814;
    public static final int CODE_SIP_SERVER_INTERNAL_ERROR = 815;
    public static final int CODE_SIP_SERVICE_UNAVAILABLE = 816;
    public static final int CODE_SIP_SERVER_TIMEOUT = 817;
    public static final int CODE_SIP_SERVER_ERROR = 818;
    public static final int CODE_SIP_USER_REJECTED = 819;
    public static final int CODE_SIP_GLOBAL_ERROR = 820;
    public static final int CODE_SIP_METHOD_NOT_ALLOWED = 821;
    public static final int CODE_SIP_PROXY_AUTHENTICATION_REQUIRED = 822;
    public static final int CODE_SIP_REQUEST_ENTITY_TOO_LARGE = 823;
    public static final int CODE_SIP_REQUEST_URI_TOO_LARGE = 824;
    public static final int CODE_SIP_EXTENSION_REQUIRED = 825;
    public static final int CODE_SIP_INTERVAL_TOO_BRIEF = 826;
    public static final int CODE_SIP_CALL_OR_TRANS_DOES_NOT_EXIST = 827;
    public static final int CODE_SIP_LOOP_DETECTED = 828;
    public static final int CODE_SIP_TOO_MANY_HOPS = 829;
    public static final int CODE_SIP_AMBIGUOUS = 830;
    public static final int CODE_SIP_REQUEST_PENDING = 831;
    public static final int CODE_SIP_UNDECIPHERABLE = 832;

...
public interface SystemConstants {
    ...
    int CATEGORY_CALL = 0x00040000;
    int CATEGORY_POWER = 0x00080000;
    int CATEGORY_TIMER = 0x00100000;
    int CATEGORY_CONFIG = 0x00200000;
    int CATEGORY_EVENT = 0x00400000;
    int CATEGORY_ISIM_EVENT = 0x00800000;
    int CATEGORY_USIM_EVENT = 0x01000000;
    int CATEGORY_RADIO = 0x02000000;
    ...
    int NOTIFY_VOICE_CALL_STATE_CHANGED = CATEGORY_CALL + 8;
    int NOTIFY_WIFI_STATE_CHANGED = CATEGORY_WIFI + 9;
    int NOTIFY_WIFI_CONNECTION_STATE_CHANGED = CATEGORY_WIFI + 10;
    int NOTIFY_CONFIGURATION_CHANGED = CATEGORY_CONFIG + 11;
    int NOTIFY_EVENT = CATEGORY_EVENT + 12;
    int NOTIFY_ISIM_EVENT = CATEGORY_ISIM_EVENT + 13;
    int NOTIFY_USIM_EVENT = CATEGORY_USIM_EVENT + 14;
    int NOTIFY_DATA_CONNECTION_IPCAN_CHANGED = CATEGORY_NETWORK + 15;
    int NOTIFY_VOICE_NETWORK_TYPE_CHANGED = CATEGORY_NETWORK + 16;
    int NOTIFY_RADIO_EVENT = CATEGORY_RADIO + 17;
    ...
    int IS_LTE_EMERGENCY_ONLY = CATEGORY_BASE + 419;

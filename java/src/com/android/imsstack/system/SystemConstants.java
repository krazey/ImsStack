...
public interface SystemConstants {
    ...
    int GET_VOICE_SERVICE_STATE = CATEGORY_BASE + 421;
    int GET_VOICE_ROAMING_TYPE = CATEGORY_BASE + 422;
    int GET_DATA_ROAMING_TYPE = CATEGORY_BASE + 423;
    int GET_MTU = CATEGORY_BASE + 424;
    int IS_EMERGENCY_ATTACH_SUPPORTED = CATEGORY_BASE + 425;
    int BIND_SOCKET = CATEGORY_BASE + 426;
    int IS_IPV6_PREFERRED = CATEGORY_BASE + 427;
